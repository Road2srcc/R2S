...
<section class="r2s-hero">
    ...
    <div class="r2s-hero-content">
        ...
        <div class="r2s-hero-cta-wrapper">
            @guest
                <a href="{{ route('login') }}" class="r2s-hero-cta">
                    Start a Free Mock
                </a>
            @endguest
            @auth
                <a href="{{ route('quiz_dashboard') }}" class="r2s-hero-cta">
                    Start a Free Mock
                </a>
            @endauth
        </div>
        ...
        <div class="r2s-hero-image-container">
            ...
            <div class="r2s-cloud r2s-cloud-top-left">
                <img src="{{ asset('images/cloud-2.png') }}" alt="">
            </div>

            <!-- School Image -->
            <div class="r2s-school-image-wrapper">
                <img src="{{ asset('images/school.png') }}" alt="SRCC College" class="r2s-school-image">
            </div>
