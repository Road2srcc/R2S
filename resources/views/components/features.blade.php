    ...
    <div class="r2s-features-container">
        ...
        <div class="r2s-feature-item" data-animate>
            ...
            <div class="r2s-feature-image">
                <img src="{{ asset('images/zero-error.png') }}" alt="Zero-Error Mocks">
            </div>
        </div>
        ...
        <div class="r2s-feature-item r2s-reverse" data-animate>
            ...
            <div class="r2s-feature-image">
                <img src="{{ asset('images/full-length.png') }}" alt="Full Length Tests">
            </div>
        </div>
        ...
        <div class="r2s-feature-item" data-animate>
            ...
            <div class="r2s-feature-image">
                <img src="{{ asset('images/scorecard.png') }}" alt="Instant Scorecards">
            </div>
        </div>
        ...
        <div class="r2s-feature-item r2s-reverse" data-animate>
            ...
            <div class="r2s-feature-image">
                <img src="{{ asset('images/ux.png') }}" alt="Smooth, Modern Interface">
            </div>
        </div>
    </div>
</section>
