    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <p class="message">
                    Thank you for joining <strong>{{ config('app.name') }}</strong>! We're thrilled to have you as part of our learning community. Your account has been successfully created and you're all set to begin your preparation journey.
                </p>
            ...
            <div class="email-footer">
                <p class="footer-text">
                    You're receiving this email because you signed up at {{ config('app.name') }}.
                </p>
                <p class="footer-text">
