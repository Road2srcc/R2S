        ...
        <div class="py-8">
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded flex items-center justify-between px-6 py-4 relative shadow">
                    <div class="absolute w-2 h-4 bg-yellow-600 ltr:left-0 rtl:right-0"></div>
                    <h3 class="focus:outline-none py-6 leading-4 text-gray-800 dark:text-gray-100 font-normal text-base">{{ __('Rank') }}</h3>
                    <div class="flex flex-col items-end">
                        <h2 class="focus:outline-none text-yellow-600 dark:text-gray-100 text-xl leading-normal font-bold">#{{ session.results.rank }}</h2>
                        <p tabindex="0" class="focus:outline-none ltr:ml-2 rtl:mr-2 mb-1 text-sm text-gray-600 dark:text-gray-400">{{ __('out of') }} {{ session.results.total_participants }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded flex items-center justify-between px-6 py-4 relative shadow">
                ...
                <!-- New Metrics -->
                <div class="bg-white dark:bg-gray-800 rounded flex items-center justify-between px-6 py-4 relative shadow">
                    <div class="absolute w-2 h-4 bg-blue-700 ltr:left-0 rtl:right-0"></div>
                    <h3 class="focus:outline-none py-6 leading-4 text-gray-800 dark:text-gray-100 font-normal text-base">{{ __('Avg. Time/Question') }}</h3>
                    <div class="flex flex-col items-end">
                        <h2 class="focus:outline-none text-blue-700 dark:text-gray-100 text-xl leading-normal font-bold">{{ avgTimePerQuestion }}</h2>
                        <p tabindex="0" class="focus:outline-none ltr:ml-2 rtl:mr-2 mb-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Question Trap') }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded flex items-center justify-between px-6 py-4 relative shadow">
                    <div class="absolute w-2 h-4 bg-purple-700 ltr:left-0 rtl:right-0"></div>
                    <h3 class="focus:outline-none py-6 leading-4 text-gray-800 dark:text-gray-100 font-normal text-base">{{ __('Percentile') }}</h3>
                    <div class="flex flex-col items-end">
                        <h2 class="focus:outline-none text-purple-700 dark:text-gray-100 text-xl leading-normal font-bold">{{ percentileDisplay }}</h2>
                        <p tabindex="0" class="focus:outline-none ltr:ml-2 rtl:mr-2 mb-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Rank') }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded flex items-center justify-between px-6 py-4 relative shadow">
                    <div class="absolute w-2 h-4 bg-indigo-700 ltr:left-0 rtl:right-0"></div>
                    <h3 class="focus:outline-none py-6 leading-4 text-gray-800 dark:text-gray-100 font-normal text-base">{{ __('Score (No Negative)') }}</h3>
                    <div class="flex flex-col items-end">
                        <h2 class="focus:outline-none text-indigo-700 dark:text-gray-100 text-xl leading-normal font-bold">{{ scoreWithoutNegativeMarking }}</h2>
                        <p tabindex="0" class="focus:outline-none ltr:ml-2 rtl:mr-2 mb-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Marks') }} {{ session.results.total_marks }}</p>
                    </div>
                </div>
            </div>
