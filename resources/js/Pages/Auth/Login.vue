    ...
    <auth-layout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-8 w-full flex justify-between">
                ...
                <a class="text-sm text-secondary" href="https://docs.google.com/forms/d/e/1FAIpQLScXviW6b8msf_L5jI3qdu5djjkzIsQbtc9SatZomOr0T3vAYg/viewform?usp=dialog" target="_blank">{{ __('Forgot Password?') }}</a>
            </div>
