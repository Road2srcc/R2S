    ...
    <section class="bg-primary" x-data="{ barOpen: true }">
        <div x-bind:class="!barOpen ? 'hidden' : ''" class="max-w-7xl mx-auto py-1 px-3 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSc99Y1kn9DqMCgKVRfeRGr63uFNjrCrrySOXq3G74jyoVFR0w/viewform?usp=sharing" target="_blank"
...
<?php endif; ?>
<?php /**PATH /home/rjus6n2feyck/public_html/resources/views/components/top-bar.blade.php ENDPATH**/ ?>