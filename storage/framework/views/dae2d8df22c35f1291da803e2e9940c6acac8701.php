<section id="explore" class="border-b border-gray-100">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:py-28 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            <h2 class="text-2xl text-secondary font-semibold tracking-wide uppercase"><?php echo e(__('Our Experts Are the Finest')); ?></h2>
...
<?php /**PATH /home/rjus6n2feyck/public_html/resources/views/components/categories.blade.php ENDPATH**/ ?>