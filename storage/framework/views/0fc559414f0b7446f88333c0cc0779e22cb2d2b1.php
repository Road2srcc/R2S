        ...
        <div x-show="open" class="r2s-mobile-wrapper" style="position: fixed; inset: 0; display: flex; z-index: 100;"
            ...
            <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
                ...
                <div class="r2s-mobile-header">
                    <img class="r2s-mobile-logo" src="<?php echo e(asset('storage/' . $siteSettings->logo_path)); ?>"
                ...
                <div class="r2s-mobile-links">
                    <a href="https://drive.google.com/drive/folders/1CDUP_q46M3yRUoVK_t3vB4V52UOxg33c?usp=sharing"
                        class="r2s-mobile-link"><?php echo e(__('Previous Year Papers')); ?></a>
                    <a href="<?php echo e(route('pricing')); ?>" class="r2s-mobile-link"><?php echo e(__('Mocks')); ?></a>
                    <a href="https://t.me/+vjPudizL2d42ZGRl" class="r2s-mobile-link"><?php echo e(__('Join Community')); ?></a>
                </div>

                <div class="r2s-mobile-auth">
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="r2s-mobile-auth-btn">
                            <?php echo e(__('Log in')); ?>

                        </a>
                    <?php endif; ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('home')); ?>" class="r2s-mobile-auth-btn">
                    ...
                    <div class="r2s-navbar-content">
                        ...
                        <div class="r2s-logo-container">
                            <a href="<?php echo e(route('welcome')); ?>">
                                ...
                                <img class="r2s-logo" src="<?php echo e(asset('storage/' . $siteSettings->logo_path)); ?>"
                                    alt="<?php echo e($siteSettings->app_name); ?>">
                            </a>
                        </div>
                        ...
                        <div class="r2s-nav-links">
                            <a href="https://drive.google.com/drive/folders/1CDUP_q46M3yRUoVK_t3vB4V52UOxg33c?usp=sharing"
                                class="r2s-nav-link"><?php echo e(__('Previous Year Papers')); ?></a>
                            <a href="<?php echo e(route('pricing')); ?>" class="r2s-nav-link"><?php echo e(__('Mocks')); ?></a>
                            <a href="https://t.me/+vjPudizL2d42ZGRl"
                                class="r2s-nav-link"><?php echo e(__('Join Community')); ?></a>
                        </div>
                        ...
                        <div class="r2s-auth-container">
                            <div class="r2s-auth-btn-wrapper">
                                <?php if(auth()->guard()->guest()): ?>
                                    <a href="<?php echo e(route('login')); ?>" class="r2s-auth-btn">
                                        <?php echo e(__('Log in')); ?>

                                    </a>
                                <?php endif; ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(route('home')); ?>" class="r2s-auth-btn">
                                        <?php echo e(__('Dashboard')); ?>
