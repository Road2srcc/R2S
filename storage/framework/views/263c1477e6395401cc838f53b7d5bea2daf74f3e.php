            ...
            <div class="flex flex-col items-start lg:w-6/12 md:w-6/12 px-4 lg:px-0 md:ml-8 justify-center py-12 sm:py-36">
                <?php if($least_price): ?>
                    <div class="mb-6 py-1.5 px-4 flex items-center justify-start bg-secondary rounded-full text-sm font-semibold text-white">
                        ...
                        <span class="pl-2"><?php echo e(__('Mocks starts from')); ?> <?php echo e($least_price); ?><?php echo e(__('')); ?></span>
                    </div>
                <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/rjus6n2feyck/public_html/resources/views/components/category-hero.blade.php ENDPATH**/ ?>