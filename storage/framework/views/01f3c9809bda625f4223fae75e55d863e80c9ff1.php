                    ...
                    <div class="h-16 sm:h-20 flex items-center">
                        ...
                        <div class="hidden lg:ltr:ml-8 lg:rtl:mr-8 lg:block lg:self-stretch">
                            <div class="h-full flex rtl:space-x-reverse space-x-8">
                                <a href="<?php echo e(url('/')); ?>#testimonial" class="flex items-center font-medium text-gray-700 hover:text-gray-800"><?php echo e(__('About Us')); ?></a><br>
                                <a href="https://t.me/+vjPudizL2d42ZGRl" class="flex items-center font-medium text-gray-700 hover:text-gray-800"><?php echo e(__('Join Community')); ?></a>
                                <a href="https://drive.google.com/drive/folders/1CDUP_q46M3yRUoVK_t3vB4V52UOxg33c?usp=sharing" class="flex items-center justify-center font-medium text-gray-700 hover:text-gray-800">
                                  <?php echo e(__('Previous Year Papers')); ?>

                                   </a>
                                <a href="<?php echo e(route('pricing')); ?>" class="flex items-center font-medium text-gray-700 hover:text-gray-800"><?php echo e(__('Mocks')); ?></a>
                            </div>
                        </div>
...
<?php /**PATH /home/rjus6n2feyck/public_html/resources/views/components/navbar.blade.php ENDPATH**/ ?>